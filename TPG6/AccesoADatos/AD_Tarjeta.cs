...
namespace TPG6.AccesoADatos
{
    public class AD_Tarjeta
    {
        ...
        public static DataTable ObtenerTablaTarjetaReporte()
        {
            string cadenaConexion = ConfigurationManager.AppSettings["CadenaDB"];
            SqlConnection cn = new SqlConnection(cadenaConexion);
            try
            {
                SqlCommand cmd = new SqlCommand();
                string consulta = "GetTarjetaReporte";
                cmd.Parameters.Clear();
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = consulta;
                cn.Open();
        ...
        public static DataTable ObtenerTablaTarjetaNombre(string nombre)
        {
            string cadenaConexion = ConfigurationManager.AppSettings["CadenaDB"];
            SqlConnection cn = new SqlConnection(cadenaConexion);
            try
            {
                SqlCommand cmd = new SqlCommand();
                string consulta = "GetTarjetaReporteNombre";
                cmd.Parameters.Clear();
        ...
        public static DataTable ObtenerTablaTarjetaBanco(int banco)
        {
            string cadenaConexion = ConfigurationManager.AppSettings["CadenaDB"];
            SqlConnection cn = new SqlConnection(cadenaConexion);
            try
            {
                SqlCommand cmd = new SqlCommand();
                string consulta = "GetTarjetaReporteBanco";
                cmd.Parameters.Clear();
