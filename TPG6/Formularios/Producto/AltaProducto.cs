    ...
    public partial class AltaProducto : Form
    {
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (camposCorrectos)
            {
                ...
                bool resultado = AccesoADatos.AD_Producto.AgregarProductoABD(p);
        ...
        private void CargarGrilla()
        {
            try
            {
                gdrActualizarProd.DataSource = AccesoADatos.AD_Producto.ObtenerTablaProducto();
            }
            catch (Exception)
            {
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            if (camposCorrectos)
            {
                bool resultado = AccesoADatos.AD_Producto.ActualizarProducto(p);
                if (resultado)
                {
        ...
        private void gdrActualizarProd_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Entidades.Producto p = AccesoADatos.AD_Producto.ObtenerProducto(idProducto);
            LimpiarCampos();
            CargarCampos(p);
        }
